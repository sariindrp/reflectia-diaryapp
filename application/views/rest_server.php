...
<body>
    ...
    <div id="container">
        ...
        <div id="body">
            ...
            <p>
                Selamat Datang Di Rest API Servis Data Dari Aplikasi REFLECTIA
            </p>
            <br>
            <ol>
                <p>
                ...
                <li><a href="<?php echo site_url('/api/PUTprofile'); ?>">PUT DATA PROFILE</a> - defaulting to JSON</li>
                <li><a href="<?php echo site_url('/api/registrasi'); ?>">POST DATA PENDAFTARAN</a> - defaulting to JSON</li>
                <li><a href="<?php echo site_url('/api/login'); ?>">POST DATA LOGIN</a> - defaulting to JSON</li>

            </ol>
            <ol>
                <p>
                    DI Bawah Link API Reflectia
                </p>
                <li><a href="<?php echo site_url('/api/dev/POSTmotivasi'); ?>">POST UNTUK DIARY</a> - defaulting to JSON</li>
                <li><a href="<?php echo site_url('/api/dev/PUTmotivasi'); ?>">PUT UPDATE DIARY</a> - defaulting to JSON</li>
                <li><a href="<?php echo site_url('/api/Get_motivasi'); ?>">GET DATA DIARY</a> - defaulting to JSON</li>
                <li><a href="<?php echo site_url('/api/dev/DELETEmotivasi'); ?>">DELETE DIARY</a> - defaulting to JSON</li>
            </ol>
